...
#ifndef CAATpiAnnotSetGlobalCopyCmd_H
#define CAATpiAnnotSetGlobalCopyCmd_H
...
//-----------------------------------------------------------------------------
class CAATpiAnnotSetGlobalCopyCmd : public CATStateCommand
{
  CmdDeclareResource(CAATpiAnnotSetGlobalCopyCmd, CATStateCommand)

  public:

    CAATpiAnnotSetGlobalCopyCmd ();
    virtual ~CAATpiAnnotSetGlobalCopyCmd ();
  ...
  private:
    ...
    CAATpiAnnotSetGlobalCopyCmd& operator=(CAATpiAnnotSetGlobalCopyCmd&);
