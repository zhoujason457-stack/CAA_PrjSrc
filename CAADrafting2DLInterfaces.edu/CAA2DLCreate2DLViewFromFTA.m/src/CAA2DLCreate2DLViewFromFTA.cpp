...
//
// Type            : Batch program
// Inputs          : The CAA2DLPartWithFTA.CATPart document containing 3D Annotations delivered in
//                         CAADrafting2DLInterfaces.edu/CNEXT/resources/graphic folder.
...
// Run command     : mkrun -c CAA2DLCreate2DLViewFrom3D C:\CAA2DLPartWithFTA.CATPart C:\TestResult.CATDrawing      
//                   
// Illustrates     : 
//                   o Retrieves the Mechanical Part
//                   o Get TPS Active view in TPS application
//                   o Creates 2DLayout from the Mechanical Part.
//                   o Creates a 2DL View from TPS view.
//                   o Creates a 2DL View from TPS captures.
//                   o Save the Part document.
//============================================================================================
