...
// ----------------------------------------------------------
// CAAPmiUdfUtilities : CONSTRUCTOR DESTRUCTOR
//-----------------------------------------------------------
...
HRESULT CAAPmiUdfUtilities::GetUdfGeometry (CATBaseUnknown* iUdf, CATUnicodeString iGeometryName, CATBaseUnknown_var &oGeometry)
{
  oGeometry = NULL_var;
  HRESULT RC = E_FAIL;
