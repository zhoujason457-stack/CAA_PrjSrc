...
//===================================================================
//
// CAAEPFforNetworkArc.h
// Provide implementation to interface CATIEcvPercentFill
//===================================================================
#ifndef CAAEPFforNetworkArc_H
#define CAAEPFforNetworkArc_H
...
*/
class CAAEPFforNetworkArc: public CATBaseUnknown

{
  ...
  CAAEPFforNetworkArc& operator=(CAAEPFforNetworkArc&);
