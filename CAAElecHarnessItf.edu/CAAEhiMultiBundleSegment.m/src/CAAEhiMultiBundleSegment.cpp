...
//===============================================================================
//  Abstract of Use Case "CAAEhiMultiBundleSegment":
//  ------------------------------------------------
//
//  This Use Case illustrates how to analyse a branchable bundle segment  and to 
//  find all support linked for each bundle segmentof the branchable bundle segment
//
//===============================================================================
//
//  Step by Step :
...
//     and analyse the first bundle segment  
...
// 10 - ERROR in creating the list of support reference
// 11 - ERROR in removing document  
// 12 - ERROR in closing session  
//
//  Running the program:
//  -------------------
// To run this program, you can use the command:
//  mkrun -c "CAAEhiMultiBundleSegment input.CATProduct" where the prefix "input" is the 
//  entire pathname of the directory in which the document is to be found and the
//  name of the document itself.
//
//
//  You may reference the supplied CATProduct document called "CAA_EHIMultiSegmentSample.CATProduct" 
//  found in the 'WS'/'OS'/resources/graphic/CAA_EHIMultiSegmentSample directory if under Unix.
//      In this case, 'OS' can be any of the following: 
//         aix_a for IBM
//         hpux_a for HP
//         irix_a for SGI
//         solaris_a for SUN
//  Under Windows, the path would indicate:  'WS'\intel_a\resources\graphic\CAA_EHIMultiSegmentSample 
//  directory. 
//
//================================================================================================
...
{ 
  ...
  char *sessionName = "CAA_EhiMultiBundleSegment_Session";
  ...
  for(int rank =1 ; rank<=TailleListBundleSegment; rank++)
  {
    ...
    //--------------------------------------------------------------------
    // 5. Retrieving Electrical Curve for each bundle segment  
    //--------------------------------------------------------------------
    ...
    for ( i =1; i<=numberOfReference; i++ )
    {
      ...
      if (NULL_var != spCBU)
        rc = spCBU->QueryInterface(IID_CATIProduct,(void**) &piReferenceProduct);
