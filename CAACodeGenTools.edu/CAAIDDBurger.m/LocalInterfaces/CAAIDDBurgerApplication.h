#ifndef CAAIDDBurgerApplication_h
#define CAAIDDBurgerApplication_h
...
class CAAIDDBurgerApplication : public CATInteractiveApplication
{
  public:
    /*
    ...
    */
    CAAIDDBurgerApplication(const CATString & iApplicationId);
    virtual     ~CAAIDDBurgerApplication();
...
private:
    ...
    // Set as private to prevent from compiler automatic creation as public.
    CAAIDDBurgerApplication(const CAAIDDBurgerApplication &iObjectToCopy);

    // Assignment operator, not implemented
    // Set as private to prevent from compiler automatic creation as public.
    CAAIDDBurgerApplication & operator = (const CAAIDDBurgerApplication &iObjectToCopy);
};
#endif
