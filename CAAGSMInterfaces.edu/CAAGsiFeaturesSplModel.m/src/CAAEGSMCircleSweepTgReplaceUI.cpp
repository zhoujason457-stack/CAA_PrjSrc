...
#include "CAAEGSMCircleSweepTgReplaceUI.h"
...
CATImplementClass(CAAEGSMCircleSweepTgReplaceUI, DataExtension, CATBaseUnknown, CAACircleSweepTg);


#include "TIE_CATIReplaceUI.h"
TIE_CATIReplaceUI(CAAEGSMCircleSweepTgReplaceUI);

//-----------------------------------------------------------------------------

CAAEGSMCircleSweepTgReplaceUI::CAAEGSMCircleSweepTgReplaceUI():CATBaseUnknown()
{
  // cout <<"CAAEGSMCircleSweepTgReplaceUI::CAAEGSMCircleSweepTgReplaceUI" << endl;
}

//-----------------------------------------------------------------------------

CAAEGSMCircleSweepTgReplaceUI::~CAAEGSMCircleSweepTgReplaceUI ()
{
 //  cout <<"CAAEGSMCircleSweepTgReplaceUI::~CAAEGSMCircleSweepTgReplaceUI" << endl;
}
...
HRESULT CAAEGSMCircleSweepTgReplaceUI::FindValidElementForReplace(const CATUnicodeString& iRole,
                                                               const CATPathElement* ipSelection,
                                                               const CATBaseUnknown* ipOldValue, 
                                                               CATBaseUnknown*& opFoundElement)
{
   // cout <<"CAAEGSMCircleSweepTgReplaceUI::FindValidElementForReplace" << endl;
