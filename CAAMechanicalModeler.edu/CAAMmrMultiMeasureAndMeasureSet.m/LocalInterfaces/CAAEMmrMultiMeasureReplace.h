...
#ifndef CAAEMmrMultiMeasureReplace_H
#define CAAEMmrMultiMeasureReplace_H
...
class CAAEMmrMultiMeasureReplace : public CATIReplace
{
	CATDeclareClass;
...
public :
	...
	virtual ~CAAEMmrMultiMeasureReplace();
...
private:
	...
	CAAEMmrMultiMeasureReplace(const CAAEMmrMultiMeasureReplace &iObjectToCopy);

	// Assignment operator, not implemented
	// Set as private to prevent from compiler automatic creation as public.
	CAAEMmrMultiMeasureReplace & operator = (const CAAEMmrMultiMeasureReplace &iObjectToCopy);
};
