...
//===================================================================
// CAAMmrPartWksFreezeUnfreezeCmd.cpp
...
//              CATISpecObject::Update is essential to achieve synchronization. 
...
//								2-4-b-1- Seek the CATISpecObject handler on the feature
...
//===================================================================
#include "CAAMmrPartWksFreezeUnfreezeCmd.h"
//CAA WIZARD INCLUDE DECLARATION SECTION: DO NOT EDIT
//END CAA WIZARD INCLUDE DECLARATION SECTION
...
CATCreateClass( CAAMmrPartWksFreezeUnfreezeCmd);

//-------------------------------------------------------------------------
// Constructor
//-------------------------------------------------------------------------
CAAMmrPartWksFreezeUnfreezeCmd::CAAMmrPartWksFreezeUnfreezeCmd() :
  CATStateCommand ("CAAMmrPartWksFreezeUnfreezeCmdId"),
  _daObjectToSelect(NULL) 
{
	cout <<" CAAMmrPartWksFreezeUnfreezeCmd::CAAMmrPartWksFreezeUnfreezeCmd" << endl;
} 
...
//-------------------------------------------------------------------------
void CAAMmrPartWksFreezeUnfreezeCmd::BuildGraph()
{
	// Statechart definition
	cout << "CAAMmrPartWksFreezeUnfreezeCmd::BuildGraph" << endl;
	...
	CATDialogTransition* pTransition1 = AddTransition(stGetObjState,
													  ...
													  Action((ActionMethod) & CAAMmrPartWksFreezeUnfreezeCmd::FreezeOrUnfreeze)
													  );
}
...
CATBoolean CAAMmrPartWksFreezeUnfreezeCmd::FreezeOrUnfreeze(void* iData)
{
	cout <<" CAAMmrPartWksFreezeUnfreezeCmd::FreezeOrUnfreeze" << endl;
	...
	// 2-4- Check for the freeze status of the copied feature
		...
		// 2-4-a- If frozen, unfreeze the selected Feature
		        ...
		        // 2-4-b- Update the feature
			    // 2-4-b-1- Seek the CATISpecObject handler type on the feature
