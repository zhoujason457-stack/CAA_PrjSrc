...
// The command name
CATCreateClass (CAADrwDimDressupCmd);

// ----------------------------------------------------------------------------
CAADrwDimDressupCmd::CAADrwDimDressupCmd():CATStateCommand(CATString("DimDressup"))
, _pObjectAgent(NULL)
{
}

// ----------------------------------------------------------------------------
CAADrwDimDressupCmd::~CAADrwDimDressupCmd()
{
