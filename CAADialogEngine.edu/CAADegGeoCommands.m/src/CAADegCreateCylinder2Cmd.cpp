...
//Local Framework
#include "CAADegCreateCylinder2Cmd.h"
...
CATCreateClass(CAADegCreateCylinder2Cmd);

//----------------------LifeCycle's PART ----------------------------------
CAADegCreateCylinder2Cmd::CAADegCreateCylinder2Cmd():CATStateCommand("CreateCylinder2CmdId"),
                        _daSelectionLine(NULL),
                        _daSelectionCircle(NULL),
                        _pUIActiveObject(NULL), _pContainer(NULL)            
{
  cout << "CAADegCreateCylinder2Cmd constructor" << endl ;
...
CAADegCreateCylinder2Cmd::~CAADegCreateCylinder2Cmd()
{
  cout << "CAADegCreateCylinder2Cmd destructor" << endl ;
...
void CAADegCreateCylinder2Cmd::BuildGraph()
{
  cout << "CAADegCreateCylinder2Cmd BuildGraph" << endl ;
  ...
  // CAADegSampleMultiDocumentCommand is the command launched in another editors
  // CAADegMultiDocCmd                this command is exported by this module
  // 
  _daSelectionCircle = new CATOtherDocumentAgent("SelectionCircleId",
	   "CAADegSampleMultiDocumentCommand","CAADegMultiDocCmd");
  ...
  (
     ...
     Action((ActionMethod) & CAADegCreateCylinder2Cmd::CreateCylinder)
  );
...
CATBoolean CAADegCreateCylinder2Cmd::CreateCylinder(void *iDummy)
{
  cout << "CAADegCreateCylinder2Cmd::CreateCylinder"<< endl;
...
CATStatusChangeRC CAADegCreateCylinder2Cmd::Activate( CATCommand *iCmd,CATNotification *iNotif)
{
  cout << " CAADegCreateCylinder2Cmd::Activate" << endl;
...
void CAADegCreateCylinder2Cmd::GetValuation   (CATMathPoint & oBasePoint,
