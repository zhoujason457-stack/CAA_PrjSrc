#ifndef CAADegCreateCylinder2Cmd_h
#define CAADegCreateCylinder2Cmd_h
...
//     - Use of CAADegSampleMultiDocumntCommand
//
//  Usage:
//
...
class CAADegCreateCylinder2Cmd : public CATStateCommand
{
  //
  ...
  CmdDeclareResource(CAADegCreateCylinder2Cmd,CATStateCommand);
  ...
  public :
    ...
    //
    CAADegCreateCylinder2Cmd();
    virtual ~CAADegCreateCylinder2Cmd();  
  ...
  private :
    ...
    CAADegCreateCylinder2Cmd(const CAADegCreateCylinder2Cmd &iObjectToCopy);

    // Assignment operator, not implemented
    // Set as private to prevent from compiler automatic creation as public.
    CAADegCreateCylinder2Cmd & operator = (const CAADegCreateCylinder2Cmd &iObjectToCopy);
