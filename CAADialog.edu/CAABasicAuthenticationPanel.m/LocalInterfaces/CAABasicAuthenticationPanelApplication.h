#ifndef CAABasicAuthenticationPanelApplication_h
#define CAABasicAuthenticationPanelApplication_h
...
//  --------------
//
//  Type : CAABasicAuthenticationPanel 
//
//=============================================================================
...
//
//  CAABasicAuthenticationPanelApplication only creates the main window and subscribes
//  to the window closing to terminate the application.  
//
//=============================================================================
//  Inheritance:
//  ------------
...
class CAABasicAuthenticationPanelApplication : public CATInteractiveApplication
{
  public:
    /*
    ...
    */
    CAABasicAuthenticationPanelApplication(const CATString & iApplicationId);
    virtual     ~CAABasicAuthenticationPanelApplication();

    /*
    * Application initialization. 
    * This method instantiates a CAABasicAuthenticationPanelWindow, calls its build
...
private:
    ...
    // Set as private to prevent from compiler automatic creation as public.
    CAABasicAuthenticationPanelApplication(const CAABasicAuthenticationPanelApplication &iObjectToCopy);

    // Assignment operator, not implemented
    // Set as private to prevent from compiler automatic creation as public.
    CAABasicAuthenticationPanelApplication & operator = (const CAABasicAuthenticationPanelApplication &iObjectToCopy);
};
#endif
