...
//=============================================================================
// Abstract of Use Case "CAAV5V6FmExtSimpleAttr":
// ---------------------------------------
//
...
//  Steps
//
//  1- Creates "Title" & "Author" Attributes  
//  2- Instantiates "CAAOsmNovel" , the instance is named Novel
//  3- Retrieves its "Author" attribute  ((own attribute)
//  4- Retrieves its "Author" attribute value  
// 5- Valuates its "Title" attribute (inherited attribute)
// 6- Retrieves its "Title" attribute value  
//
// - Saves the session
// - Closes the session
//
...
//        mkrun -c "CAAV5V6FmExtSimpleAttr DocumentStorageName" 
...
{ 
	...
	{
		cout << endl;
		cout << "Usage: CAAV5V6FmExtSimpleAttr <Repository> <Server> <User> <Password> <SecurityCtx> <Environment> " ;
		cout <<endl;
		return 1;
	}

	cout << "The CAAV5V6FmExtSimpleAttr main program begins in V6 env...."<< endl << endl;
