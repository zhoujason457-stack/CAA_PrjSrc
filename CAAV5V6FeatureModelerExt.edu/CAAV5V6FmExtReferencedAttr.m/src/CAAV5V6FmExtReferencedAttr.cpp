...
//=============================================================================
// Abstract of Use Case "CAAV5V6FmExtReferencedAttr":
// -------------------------------------------
//
...
//        mkrun -c "CAAV5V6FmExtReferencedAttr DocumentStorageName" 
...
{ 
	...
	{
		cout << endl;
		cout << "Usage: CAAV5V6FmExtReferencedAttr <Repository> <Server> <User> <Password> <SecurityCtx> <Environment> " ;
		cout <<endl;
		return 1;
	}
	cout << "The CAAV5V6FmExtReferencedAttr main program begins in V6 env ...."<< endl << endl;
	...
	//--------------------------------------------------------------------------------
	//6- Retrieve Keys to Attributes associated with the features to be instantiated
	//--------------------------------------------------------------------------------
	// 6-1- Retrieve a key to the "PublisherName" attribute (string)
	CATFmAttributeName PublshrNameAttrKey("PublisherName");

	// 6-2- Retrieve a key to the "PublisherAddress" attribute (string)
	CATFmAttributeName PublshrAddrAttrKey("PublisherAddress");

	// 6-3- Retrieve a key to the "BookPublisher" attribute (tk_specObject)
	CATFmAttributeName BookPublshrAttrKey("BookPublisher");

	// 6-4- Retrieve a key to the "NovelChapter" attribute (tk_component)
	...
	CATUnicodeString MyPublisherStartUpType("`CAAOsmPublisher`@`CAAOsmCatalogSU.CATfct`");
	CATFmStartUpFacade PublisherStartUpFacade(MyCredential, MyPublisherStartUpType);
	...
	cout << endl << "The CAAV5V6FmExtReferencedAttr main program ends ...."<< endl << endl;
	return 0;
