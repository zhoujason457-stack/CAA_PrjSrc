...
//
// --------------------------------------------------------------------------------------------------
#include "CAAEV5V6FmExtBehaviorCustomizationSquare.h" 
...
CATImplementClass(CAAEV5V6FmExtBehaviorCustomizationSquare,
				  DataExtension,
                  CATIFmFeatureBehaviorCustomization,
				  CAAOsmSquare);
CATImplementBOA(CATIFmFeatureBehaviorCustomization,CAAEV5V6FmExtBehaviorCustomizationSquare); 

//-----------------------------------------------------------------------------
// Constructor
//-----------------------------------------------------------------------------
CAAEV5V6FmExtBehaviorCustomizationSquare::CAAEV5V6FmExtBehaviorCustomizationSquare()
{
}
...
HRESULT CAAEV5V6FmExtBehaviorCustomizationSquare::Build()
{
	...
	CATFmFeatureFacade FmFeatFacadeOnCAAEV5V6FmExtBehaviorCustomizationSquare(MyCredential,this);
	// 3-2- Retrieve the value of the "Num" attribute
	CATFmAttributeValue FmAttrValue;
	int iNum = 0;
	HRESULT rc =  FmFeatFacadeOnCAAEV5V6FmExtBehaviorCustomizationSquare.GetValue(SqrNumAttrKey,FmAttrValue);
	if (SUCCEEDED(rc))
	...
	if (SUCCEEDED(rc))
	{
		...
		rc =  FmFeatFacadeOnCAAEV5V6FmExtBehaviorCustomizationSquare.SetValue(SqrSqrAttrKey,FmAttrValue);
		
		// 4-2- Retrieve the value of the attribute "Square". Confirm if it is set to the new value
		if (SUCCEEDED(rc))
		{
			rc =  FmFeatFacadeOnCAAEV5V6FmExtBehaviorCustomizationSquare.GetValue(SqrSqrAttrKey,FmAttrValue);
			if (SUCCEEDED(rc))
			{
				int iSqrValue = 0;
