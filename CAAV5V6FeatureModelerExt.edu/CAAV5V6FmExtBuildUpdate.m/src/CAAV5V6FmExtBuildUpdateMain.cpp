...
//=============================================================================
// Abstract of Use Case "CAAV5V6FmExtBuildUpdate":
// -------------------------------------------
//
...
// CAAEV5V6FmExtBehaviorCustomizationSquare::Update() detects CAAOsmAdd as a feature modified upstream, owing to the 
// referencing link that exists from "Num" to "Sum". 
// The CAAEV5V6FmExtBehaviorCustomizationAdd::Update() is triggered which launches the CAAEFmExtBehaviorCustomizationAdd:Build()
...
// Once "Num", an sp_IN attribute of CAAOsmSquare is updated, it triggers the CAAEV5V6FmExtBehaviorCustomizationSquare::Build() 
// The CAAEV5V6FmExtBehaviorCustomizationSquare::Build() computes the "Square" attribute, by squaring "Num"
...
// The catalog is provided in the directory CAAV5V6FeatureModelerExt.edu\CNext\resources\graphic 
...
//			4-1- CAAEV5V6FmExtBehaviorCustomizationSquare::Update() triggers the CAAEV5V6FmExtBehaviorCustomizationAdd::Build()
//			4-2- CAAEV5V6FmExtBehaviorCustomizationAdd::Build() which in turn triggers CAAEV5V6FmExtBehaviorCustomizationSquare::Build()
...
//        mkrun -c "CAAV5V6FmExtBuildUpdate DocumentStorageName" 
...
{ 
	...
	{
		cout << endl;
		cout << "Usage: CAAV5V6FmExtBuildUpdate <Repository> <Server> <User> <Password> <SecurityCtx> <Environment> " ;
		cout <<endl;
		return 1;
	}

	cout << "The CAAV5V6FmExtBuildUpdate main program begins ...."<< endl << endl;
	...
	cout << endl << "The CAAV5V6FmExtBuildUpdate main program ends ...."<< endl << endl;
	return 0;
