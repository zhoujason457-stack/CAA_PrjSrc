...
//=============================================================================
// Abstract of Class "CAAEV5V6FmExtBehaviorCustomizationAdd":
// -------------------------------
//
...
#ifndef CAAEV5V6FmExtBehaviorCustomizationAdd_H_ 
#define CAAEV5V6FmExtBehaviorCustomizationAdd_H_ 

#include "CATFmFeatureCustomizationAdaptor.h"

class CAAEV5V6FmExtBehaviorCustomizationAdd : public CATFmFeatureCustomizationAdaptor 
{
 CATDeclareClass;
