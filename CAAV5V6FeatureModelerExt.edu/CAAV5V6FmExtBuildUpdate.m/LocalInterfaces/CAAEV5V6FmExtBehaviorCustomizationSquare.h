...
//=============================================================================
// Abstract of Class "CAAEV5V6FmExtBehaviorCustomizationSquare":
// ----------------------------------
//
...
#ifndef CAAEV5V6FmExtBehaviorCustomizationSquare_H_ 
#define CAAEV5V6FmExtBehaviorCustomizationSquare_H_ 

#include "CATFmFeatureCustomizationAdaptor.h"

class CAAEV5V6FmExtBehaviorCustomizationSquare : public CATFmFeatureCustomizationAdaptor
{
	CATDeclareClass;
...
private:
	...
	CAAEV5V6FmExtBehaviorCustomizationSquare();
	  virtual ~CAAEV5V6FmExtBehaviorCustomizationSquare();
