...
/**
 * SampleViewModel. Implement List model interfaces.
 * This class link the view with the application model.
 **/
class SampleViewModel: public CATExtIDlgTableViewModel
{
  CATDeclareClass;
   ...
   * Constructor
   **/
  SampleViewModel( void );
  /**
   * Destructor
   **/
  virtual ~SampleViewModel( void );
