...
#ifndef SampleColVariantModel_H
#define SampleColVariantModel_H
...
/**
 * SampleColVariantModel. Model for set of columns: names, width...
 **/
class SampleColVariantModel: public CATExtIDlgTableViewColumnModel
{
    CATDeclareClass;
...
public:
     ...
     * Constructor
     **/
    SampleColVariantModel( void );
    /**
     * Destructor
     **/
    virtual ~SampleColVariantModel( void );
