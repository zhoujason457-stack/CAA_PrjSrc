...
extern CAACafViewerFeedbackManager * _ViewerFeedbackManager = NULL ;

//-------------------------------------------------------------------------

CAACafViewerFeedbackManager::CAACafViewerFeedbackManager():
_ViewerFeedbackCB(0),_WindowActivatedCB(0),_WindowDeactivatedCB(0),_WindowDeletedCB(0),
_pCurrentViewer(NULL),_pInformationsToDisplay(NULL)
{
    cout <<" CAACafViewerFeedbackManager::CAACafViewerFeedbackManager" << endl;
}
...
void CAACafViewerFeedbackManager::GetManager(CAACafViewerFeedbackManager ** opManager)
{
	if ( NULL != opManager )
	{      
       *opManager = NULL ;
       ...
       {
          *opManager = new CAACafViewerFeedbackManager() ;
...
{
    cout << " CAACafViewerFeedbackManager::SetViewerFeedbackOn" << endl;
    ...
    if (0 == _WindowActivatedCB)
    {
        _WindowActivatedCB = ::AddCallback(this,
                            ...
                            (CATSubscriberMethod) & CAACafViewerFeedbackManager::WindowActivatedCB, NULL);
    }
    if (0 == _WindowDeactivatedCB)
    {
        _WindowDeactivatedCB = ::AddCallback(this,
                            ...
                            (CATSubscriberMethod) & CAACafViewerFeedbackManager::WindowDeactivatedCB, NULL);
    }
    if (0 == _WindowDeletedCB)
    {
...
{
    cout << " CAACafViewerFeedbackManager::SetViewerFeedbackOff" << endl;
                                              ...
                                              CATCallback        callback)
{
  if ( NULL != _pCurrentViewer )
  {
     ...
     if (NULL != pFeedbackEvent)
     {
         ...
         {
           // 
           // 2-b Builds a new graphic representation
           // The graphic representation will be displayed in the main 2D viewpoint
           // of the 3D or 2D current viewer
           //
...
void CAACafViewerFeedbackManager::PathElementString(CATPathElement * ipPath, 
...
void CAACafViewerFeedbackManager::WindowActivatedCB( CATCallbackEvent   event,
                                              ...
                                              CATCallback        callback)
{
    cout << " CAACafViewerFeedbackManager::WindowActivatedCB"  << endl;
...
void CAACafViewerFeedbackManager::WindowDeactivatedCB( CATCallbackEvent   event,
                                              void             * client,
                                              CATNotification  * notification,
                                              CATSubscriberData  data,
                                              CATCallback        callback)
{
    cout << " CAACafViewerFeedbackManager::WindowDeactivatedCB"  << endl;
