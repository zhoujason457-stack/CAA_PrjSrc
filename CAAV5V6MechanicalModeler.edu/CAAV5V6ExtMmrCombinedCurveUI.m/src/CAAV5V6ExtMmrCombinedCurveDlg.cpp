...
// Local Framework
#include "CAAV5V6ExtMmrCombinedCurveDlg.h"   

// System Framework
#include "CATUnicodeString.h"

// ApplicationFrame Framework in V5
// AfrFoundation Framemwork in V6
...
CAAV5V6ExtMmrCombinedCurveDlg::CAAV5V6ExtMmrCombinedCurveDlg( ) :
CATDlgDialog ( ( CATApplicationFrame::GetApplicationFrame() ) -> GetMainWindow ( ) ,
               "V5V6ExtCombinedCurve", 
...
//-------------------------------------------------------------------------
// CAAV5V6ExtMmrCombinedCurveDlg::Build()
//-------------------------------------------------------------------------

void CAAV5V6ExtMmrCombinedCurveDlg::Build()
{
...
//-------------------------------------------------------------------------
// CAAV5V6ExtMmrCombinedCurveDlg::SetActiveField()
//-------------------------------------------------------------------------

void CAAV5V6ExtMmrCombinedCurveDlg::SetActiveField(int iFieldNumber)
{
...
//-------------------------------------------------------------------------
// CAAV5V6ExtMmrCombinedCurveDlg::SetName()
//-------------------------------------------------------------------------

void CAAV5V6ExtMmrCombinedCurveDlg::SetName(int iFieldNumber , CATUnicodeString iName )
{
...
//-------------------------------------------------------------------------
// CAAV5V6ExtMmrCombinedCurveDlg::GetField()
//-------------------------------------------------------------------------

CATDlgSelectorList* CAAV5V6ExtMmrCombinedCurveDlg::GetField(int iFieldNumber)
{
