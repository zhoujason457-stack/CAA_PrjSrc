...
#ifndef CAAEV5V6ExtMmrCombinedCurveAdn_H
#define CAAEV5V6ExtMmrCombinedCurveAdn_H
 ...
 */
class CAAEV5V6ExtMmrCombinedCurveAdn : public CATBaseUnknown
{
  // Used in conjunction with CATImplementClass in the .cpp file 
  CATDeclareClass;

  public:
     CAAEV5V6ExtMmrCombinedCurveAdn();
     virtual ~CAAEV5V6ExtMmrCombinedCurveAdn();
