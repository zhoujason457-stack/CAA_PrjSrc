...
#ifndef CAAPspBaseEnvProtected_H
#define CAAPspBaseEnvProtected_H

#include "CAAPspUtilitiesProtected.h"
...
class ExportedByCAAPspUtilities CAAPspBaseEnvProtected
                                    
{
  public:
    ...
    virtual ~CAAPspBaseEnvProtected();
