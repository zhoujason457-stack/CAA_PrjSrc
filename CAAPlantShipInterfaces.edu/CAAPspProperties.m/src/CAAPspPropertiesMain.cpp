...
//  
//        mkrun -c "CAAPspProperties CAAPspEduIn.CATProduct"
//  
...
{
  cout << "Start main CAAPspProperties" << endl;
  ...
  cout << "End main CAAPspProperties" << endl;
  return rc;
}
