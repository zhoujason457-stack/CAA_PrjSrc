...
//=============================================================================
//
// CAAPspLogicalLineMain
//
//  This sample illustrates how to use the CAA Plant Ship interfaces to:
//
//  1. Query a share data catalog to get a list of IDs.
//  2. Find a logical line's 'From' and 'To' objects based on the flow
//     direction of the line string objects.
//
//  Prerequisite: 
//  -------------------
...
//  
//        mkrun -c "CAAPspLogicalLine CAAPspEduIn.CATProduct"
//  
...
{
  cout << "Start main CAAPspLogicalLine" << endl;
  ...
  cout << "End main CAAPspLogicalLine" << endl;
  return rc;
}
