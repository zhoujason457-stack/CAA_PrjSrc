#ifndef CAAEVisHistogramChartVisuForRootObject_H
#define CAAEVisHistogramChartVisuForRootObject_H
...
class CAAEVisHistogramChartVisuForRootObject : public CATExtIVisu
{
  ...
  public:
    ...
    virtual ~CAAEVisHistogramChartVisuForRootObject();

    // Constructs a CAT2DRep with 2D GP to construct an histogram 
    // 
  ...
  CAAEVisHistogramChartVisuForRootObject(const CAAEVisHistogramChartVisuForRootObject &iObjectToCopy);

  // Assignment operator, not implemented
  // Set as private to prevent from compiler automatic creation as public.
  CAAEVisHistogramChartVisuForRootObject & operator = (const CAAEVisHistogramChartVisuForRootObject &iObjectToCopy);
